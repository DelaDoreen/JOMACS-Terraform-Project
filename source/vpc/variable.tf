...
variable "project_pub_rt_name" {
  default = "project_pub_rt"
  type    = string
}
...
variable "project_private_rt_name" {
  default = "project_private_rt"
  type    = string
}
